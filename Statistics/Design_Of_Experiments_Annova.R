...
>
Type=c(rep("Type1",length(D1)),rep("Type2",length(D2)),rep("Type3",length(
D3)))
> Type
16BEE0023
Varun Singh Inda
...
BD - ANOVA for 2 Way Classification
...
16BEE0023
Varun Singh Inda
[1] "Summer" "Summer" "Summer" "Summer" "Winter" "Winter"
"Winter"
[8] "Winter" "Monsoon" "Monsoon" "Monsoon" "Monsoon"
> Salesman=c(rep(c("SalesA", "SalesB", "SalesC", "SalesD"),3))
> Salesman
[1] "SalesA" "SalesB" "SalesC" "SalesD" "SalesA" "SalesB" "SalesC"
"SalesD"
[9] "SalesA" "SalesB" "SalesC" "SalesD"
